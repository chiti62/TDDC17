...
//    	double angleNow = angle.getValue();
//    	double vxNow = vx.getValue();
//    	double xyNow = vy.getValue();
    	System.out.println("SENSORS: a=" + df.format(angle.getValue()) + " vx=" + df.format(vx.getValue()) + 
